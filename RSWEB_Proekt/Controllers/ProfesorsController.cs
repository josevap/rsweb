...
namespace RSWEB_Proekt.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public ProfesorsController(RSWEB_ProektContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,StepenNaObrazovanie,AkademskiRang")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,StepenNaObrazovanie,AkademskiRang")] Profesor profesor)
        {
            if (id != profesor.Id)
            {
                return NotFound();
