...
namespace RSWEB_Proekt.Controllers
{
    public class PredmetsController : Controller
    {
        ...
        public PredmetsController(RSWEB_ProektContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Semestar,Programa")] Predmet predmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Semestar,Programa")] Predmet predmet)
        {
            if (id != predmet.Id)
            {
                return NotFound();
